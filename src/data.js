    ...
    projects: [
        {
            ...
            description: "A comprehensive enterprise resource planning (ERP) system was developed to centralize data and optimize the quotation and garment manufacturing processes, whose backend architecture was designed under a hexagonal architecture pattern using the Django framework and PostgreSQL for data persistence and migration management; for the frontend user interface environment, React with TypeScript was implemented, making use of web components and hooks for efficient consumption of API endpoints, while the development also included prototyping in Lovable, service validation in Postman, and collaborative management under agile methodologies with Jira, with version control in Git.",
            link: "#"
        },
        {
            id: 2,
            title: "ventacucuta.com",
            description: "A proprietary e-commerce platform was designed for online sales, featuring a complete ecosystem that supports everything from product selection to payment and shipping, developed using WordPress and Hostinger and equipped with custom functionalities and features through PHP and JavaScript-based plugins; the project also included the integration of payment gateways, user experience optimization, and the application of SEO and digital marketing best practices, aimed at the site's technical operation and maintenance.",
            link: "https://ventacucuta.com/"
        },
        {
            id: 3,
            title: "Smart Flow",
            description: "A classroom reservation and management system was designed for Colegio Ebenezer to optimize the control of institutional spaces, built using the Laravel framework based on PHP for all backend business logic; for the frontend user interface environment, HTML, CSS, and JavaScript were implemented, supporting data storage and persistence through a structured relational database in SQL.",
